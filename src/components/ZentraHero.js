...
export default function ZentraHero() {
  return (
    <section className="relative overflow-hidden">
      ...
      {/* HERO CONTENT */}
      <div className="flex flex-col items-center justify-center px-4 text-center relative top-40">
        {/* Traders Joined */}
        ...
        >
          World’s 1st psychological performance dashboard for traders
        </p>
      ...
      <div
        className="w-full h-[92px] absolute bottom-0 left-0 right-0 z-10"
        style={{
          background:
