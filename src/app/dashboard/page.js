...
export default function Dashboard() {
  ...
  const transformedConsistencyData =
    consistencyTrendData?.scores && Array.isArray(consistencyTrendData.scores)
      ...
      : consistencyTrendData?.history && Array.isArray(consistencyTrendData.history)
      ...
      : null;
  console.log('✅ [Dashboard] Transformed consistency data:', transformedConsistencyData);
  ...
  const transformedRadarData =
    ...
    Array.isArray(psychologicalRadarData.traits)
      ...
      ? Object.fromEntries(
          Object.entries(psychologicalRadarData.data).map(([key, value]) => [
            key,
  ...
  return (
    <>
      ...
      <div className="min-h-screen p-2 sm:p-4 md:p-6 relative w-full bg-white">
        <div className="w-full max-w-[1800px] mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-xl text-primary font-medium">
              {getGreeting()}, {userData?.name ? userData.name.split(" ")[0] : "Hamail"}
            </p>
          </div>

          {/* Main Grid Structure - 3 Column Layout */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-stretch">
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <MentalBatteryCard
                  ...
                  level={
                    mentalBatteryData?.status === "optimal"
                      ...
                      ? "High Risk"
                      : summaryData?.quickStats?.mentalBatteryLevel || "Medium"
                  }
              ...
              <div className="h-[380px]">
                <PsychologicalStabilityTrend
                  data={
                    transformedConsistencyData || summaryData?.stabilityCurve
                  }
                  hasNoTrades={hasNoTrades}
                  fetchHistory={fetchConsistencyTrendHistory}
                  refetch={refetchConsistencyTrend}
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              <div className="h-[200px]">
                <PerformanceWindow
                  message={performanceWindowData?.message}
                  daysStreak={
                    performanceWindowData?.daysStreak ||
                    summaryData?.quickStats?.planStreak ||
                    3
                  }
                  hasNoTrades={hasNoTrades}
                />
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              <div className="h-[430px]">
                <PsychologicalStateDistribution
                  data={transformedRadarData || summaryData?.stateDistribution}
                  hasNoTrades={hasNoTrades}
                />
              </div>
            </div>
